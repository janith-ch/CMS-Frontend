    ...
    return(
        <div className='sidebar'>
            ...
            <Link style={{ textDecoration: 'none' }} to='/dashboard'>
                <div>
                    <img alt='selectedIcon' hidden={!setArrowNew('dashboard')} src={arrowIcon}/>
            ...
            <Link to='/measure'>
                <div>
                    <img alt='selectedIcon' hidden={!setArrowNew('measure')} src={arrowIcon}/>
                    <div className='cardView'>
            ...
            <Link to='/history'>
                <div>
                    <img alt='selectedIcon' hidden={!setArrowNew('history')} src={arrowIcon}/>
                    <div className='cardView'>
            ...
            <Link to='/view_Doctors'>
                <div>
                    <img alt='selectedIcon' hidden={!setArrow('Doctors')} src={arrowIcon}/>
                    <div className='cardView'>
            ...
            <Link to='/view_Clinics'>
                <div>
                    <img alt='selectedIcon' hidden={!setArrow('Clinics')} src={arrowIcon}/>
                    <div className='cardView'>
